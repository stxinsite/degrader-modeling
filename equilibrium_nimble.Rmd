...
uM <- numeric(nrow(nanobret_96))
mBU_corrected <- numeric(nrow(nanobret_96))

for (i in 1:nrow(nanobret_96)) {
  dataPoint <- nanobret_96[i,]
  B_t <- dataPoint[['uM']]
  constructInt <- dataPoint[['construct_int']]
...
nanobret_96_fit <- data.frame(
  uM,
  mBU_corrected,
  Construct = nanobret_96$Construct,
  source = "predicted"
)
